  ...
  return (  
    <div className="about-page">
        <div className="heading">
            ...
            <div className="bodyEm">Currently I am on my journey of learning web development.  I would like to document this beautiful journey. I have created some technical blogs. You can check out those blogs listed on <Link className="link-animation" style={styleLink} to="/myblogs"><a>My blogs</a></Link> page. 
            <br /><br/>
